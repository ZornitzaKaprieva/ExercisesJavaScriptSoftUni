...
function salary(input) {
  ...
  for (let i = 0; i <= input.length; i++) { //i <= openTabs
    let website = input[i];
  ...
  let facebookFine = facebookCount * 150;
  let instagramFine = instagramCount * 100;
  let redditFine = redditCount * 50;

  let fine = facebookFine + instagramFine + redditFine;

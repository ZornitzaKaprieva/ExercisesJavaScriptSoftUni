...
function worldSwimminRecord(input){
    ...
    let delay = (distanceMeters/15) * 12.5; 

    let ivanTime = distanceMeters * timeSec1m + delay;
    let diff = Math.abs(recordSec - ivanTime);

    if(recordSec > ivanTime){
...
worldSwimminRecord(["55555.67", "3017", "5.03"]);

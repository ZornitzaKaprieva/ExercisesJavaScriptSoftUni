...
function gameNumberWars(input) {
  ...
  while (command !== "End of game") {
    ...
    let player2card = Number(input.shift());
    ...
    if (player1card > player2card) {
      ...
      let player1NewCard = Number(input.shift());
      let player2NewCard = Number(input.shift());
  ...
  if (haveWinner) {
    ...
    console.log(`${player1name} has ${scorePlayer1} points`);
    console.log(`${player2name} has ${scorePlayer2} points`);
  }
}
